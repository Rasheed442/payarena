...
import ChangeWalletPin from "../../modals/ChangeWalletPin";
import ResetWalletPin from "../../modals/ResetWalletPin";
  ...
  return (
    <div>
      ...
      <div className="bg-white border mt-4 border-[#F0F0F0] rounded-lg">
        ...
        {/* TO CHANGE WALLET PIN NEW  FEATURE */}
        <div>
          <div
            onClick={() => {
              setCurrent("WalletPinChange");
            }}
            className="p-6 border-b border-[#F0F0F0] text-2xl flex justify-between items-center cursor-pointer"
          >
            <span>Change Wallet Pin</span> <ArrowDownIcon />
          </div>
          {current === "WalletPinChange" && (
            <div className="p-6 border-b border-[#F0F0F0] grid grid-cols-2">
              <span className="text-lg">
                To change your pin, click the change
                <br /> pin button to proceed.
              </span>{" "}
              <Button
                text="CHANGE PIN"
                background="#F58220"
        ...
        {/*TO RESET WALLET PIN NEW FEATURE */}
        <div>
          <div
            onClick={() => {
              setCurrent("ResetWalletPin");
            }}
            className="p-6 border-b border-[#F0F0F0] text-2xl flex justify-between items-center cursor-pointer"
          >
            <span>Reset Wallet Pin</span> <ArrowDownIcon />
          </div>
          {current === "ResetWalletPin" && (
            <div className="p-6 border-b border-[#F0F0F0] grid grid-cols-2">
              <span className="text-lg">
                To change your pin, click the change
                <br /> pin button to proceed.
